...
const store = (set,get) => ({
    parameters: [ {type: "select", id:"passes", label:"# of passes", value:"2", options:["2","3","4","5","6","7"]},
                  ...
                  {type: "slider", id:"force", label:"Force", value:14,min:0,max:30,unit: "N"},
                  {type: "slider", id:"speed", label:"Feed Rate", value:20,min:1,max:100, unit: "mm/s"},
                  {type: "slider", id:"pitch", label:"Pitch angle", value:0,min:-5,max:5, unit: "deg"},
