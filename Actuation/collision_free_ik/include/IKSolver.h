...
public:
    ...
    bool solve(double* current_q, const std::array<double, 7>& trans, double* q, double* trans_return, bool* local, bool* underconstrained) {
        return IKSolverInterface::solve(solver_ptr, current_q, &trans, q, trans_return, local, underconstrained);
    }
